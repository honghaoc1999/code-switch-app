...
if (navigator.mediaDevices) {
  ...
  .then(function(stream) {
    ...
    function processAudioChunk(runFull, lastChunk) {
      counter += 1;
      var newPeriod = (counter % counterPeriod == 0 || lastChunk);
      // var newPeriod = true;
          ...
          if (this.readyState == 4 && this.status == 200) { 
            ...
            if (jsonResponse["output"]) {
              ...
              if (lastChunk) {
                ...
                console.log("transcribe-text-"+jsonResponse["messageNum"], document.getElementById("transcribe-text-"+jsonResponse["messageNum"]));
